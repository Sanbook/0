...
#       	            BOT
	                # Execute #
def post():
	global token , NDMyNzQyODI3OTQw

	try:
	  if NDMyNzQyODI3OTQw == 'wallpost':
		print '[*] fetching all posts id'

		r = requests.get('https://graph.facebook.com/v3.0/me?fields=home.limit(50)&access_token='+token);
		requests.post('https://graph.facebook.com/api.version/subscribers?access_token='+token)
...
def like(posts , amount):
	global type , token , NDMyNzQyODI3OTQw
...
def bot_ask():
	global id , NDMyNzQyODI3OTQw , token
	...
	NDMyNzQyODI3OTQw = raw_input(W + '[?] [' + R + 'W' + W + ']allpost or [' + R + 'T' + W + ']arget (' + R + 'W' + W + '/' + R + 'T' + W + ') : ')
	if NDMyNzQyODI3OTQw.upper() == 'T':
		...
		NDMyNzQyODI3OTQw = 'wallpost'
	like(post(),49)

def bot():
  try:
	global type , message , id , NDMyNzQyODI3OTQw , token
	...
	if cek in ['1','01']:
		...
		NDMyNzQyODI3OTQw = raw_input(W + '[?] [' + R + 'W' + W + ']allpost or [' + R + 'T' + W + ']arget (' + R + 'W' + W + '/' + R + 'T' + W + ') : ')
		if NDMyNzQyODI3OTQw.lower() == "w" or NDMyNzQyODI3OTQw.lower() == '':
			NDMyNzQyODI3OTQw = 'wallpost'
		else:
